...
namespace Assets.Scripts.Views
{
    ...
    public class SlideNoteView : NoteView
    {
        ...
        {
            noteSpriteRenderer.sprite = slideNoteSprite;
            noteSpriteRenderer.transform.localScale = SlideNoteScale * new Vector3(noteSize, 1.0f, 1.0f);
